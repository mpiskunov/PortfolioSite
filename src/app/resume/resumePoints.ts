...
export const resumePointArray: ResumePointProps[] = [
  ...
  },
  {
    ...
    order: 5,
    displayItem: true,
    textValue: `Authored a comprehensive integration testing suite using MockServer, implemented across multiple applications, and delivered presentations to various teams on its setup and usage.`,
